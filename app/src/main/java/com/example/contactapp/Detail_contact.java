...
public class Detail_contact extends AppCompatActivity implements View.OnClickListener {
    ...
    private void insertContactINFavoris(String nomContact, String prenomContact, String emailContact, String serviceContact, String telContact, String urlImgContact) {
        ...
        CollectionReference docRef = db.collection("user").document(currentUser.getEmail()).collection("contactFavoris");
    ...
    public void onClick(View view) {
        if(view.getId()==R.id.favorite_button){
            ...
            insertContactINFavoris(nomContact, prenomContact, emailContact,serviceContact, telContact, urlImgContact );
