...
public class Liste_favoris extends AppCompatActivity implements View.OnClickListener {
        ...
        barreRecherche.addTextChangedListener(new TextWatcher() {
            public void onTextChanged(CharSequence query, int start, int before, int count) {
                ...
                if (query.toString().isEmpty()) {
                    ...
                    MyAdapter myAdapter = new MyAdapter(contacts, Liste_favoris.this);
                    ...
                    MyAdapter myAdapter = new MyAdapter(filteredContacts, Liste_favoris.this);
                    contactsRecycler.setAdapter(myAdapter);
                }
            }
    ...
    void getContacts() {
        ...
        docRef.collection("contactFavoris").get()
